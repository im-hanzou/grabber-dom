...
$banner = "
{$cyan}*******************************************
{$hijau}Grab domain per page {$kuning}[{$reset}{$merah}new domain{$reset}{$kuning}]{$reset}
       {$hijau}Coded by Zaen
        about.me/zaenhxr 
{$cyan}*******************************************{$reset}\n\n";
echo $banner;
function scrap_newdomain($page)
{
    global $hijau, $kuning, $merah, $cyan, $reset;
    $url = "https://www.hupso.com/new/" . $page;
